...
internal class Program
{
    ...
    /// <summary>
    /// Формирует фигуры из символов <paramref name="symbol"/> с размером стороны <paramref name="n"/>.
    /// </summary>
    /// <param name="n">Размер стороны фигуры.</param>
    /// <param name="symbol">Символ, используемый для построения фигур.</param>
    /// <returns>Строка с рисунками фигур.</returns>
